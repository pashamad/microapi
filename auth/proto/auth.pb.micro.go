...
type AuthService interface {
	LoginApple(ctx context.Context, in *LoginAppleRequest, opts ...client.CallOption) (*LoginAppleResponse, error)
...
func (c *authService) LoginApple(ctx context.Context, in *LoginAppleRequest, opts ...client.CallOption) (*LoginAppleResponse, error) {
	req := c.c.NewRequest(c.name, "Auth.LoginApple", in)
	out := new(LoginAppleResponse)
...
type AuthHandler interface {
	LoginApple(context.Context, *LoginAppleRequest, *LoginAppleResponse) error
...
func RegisterAuthHandler(s server.Server, hdlr AuthHandler, opts ...server.HandlerOption) error {
	type auth interface {
		LoginApple(ctx context.Context, in *LoginAppleRequest, out *LoginAppleResponse) error
...
func (h *authHandler) LoginApple(ctx context.Context, in *LoginAppleRequest, out *LoginAppleResponse) error {
	return h.AuthHandler.LoginApple(ctx, in, out)
}
